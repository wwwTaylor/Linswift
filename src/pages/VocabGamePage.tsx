...
import {
  ChevronLeft, Link, PenTool, Headphones, Zap, Trophy, Medal, Award,
} from 'lucide-react'

/**
 * 游戏记忆模式 —— 背单词模块
 * 功能：
 *  1. 四种游戏模式卡片：连连看、拼写挑战、听音辨词、限时闪电
 *  2. 排行榜（本周前三名）
 *  3. 个人最佳成绩
 */
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)]">
      ...
      <div className="mx-5 mb-5 p-4 rounded-[var(--radius-lg)] text-white"
        ...
        <p className="text-[12px] text-white/80 mb-1">本周最佳成绩</p>
        <div className="flex items-end gap-2">
          <span className="text-[36px] font-bold leading-none">1,850</span>
        ...
        <div className="space-y-3">
          {gameModes.map((mode, i) => (
            ...
            >
              ...
              {/* 预计时间 */}
              <span className="text-[11px] px-2.5 py-1 bg-[var(--color-background-secondary)] rounded-full text-[var(--color-muted)] shrink-0">
                {mode.time}
              </span>
            </button>
          ))}
